import svg from '../assets/images/web-development-svgrepo-com.svg';
...
const CardService: React.FC<CardServiceProps> = ({
    ...
    return (
        <div className="rounded-sm  border-4 border-gray-500">
                    ...
                    <div className="flex flex-col gap-2">
                        <h2 className="text-white capitalize text-3xl font-bold">
                            {department === 'design'
                                ...
                                : null}
                            <br />
                            <strong className="capitalize text-3xl font-bold">
                                {department === 'design' ||
                                department === 'development'
                                    ? 'web'
                                    : 'digital'}
...
//                         <g>
//                             <path
//                                 d="M245.221,348.125c-56.477,0-102.424-46.162-102.424-102.903s45.947-102.904,102.424-102.904
...
//                         <g>
//                             <path
//                                 d="M257.532,490h-0.001h-25.06c-24.58,0-44.579-20.078-44.58-44.758v-39.457c-5.296-1.908-10.519-4.091-15.625-6.532
...
//                 <h2>
//                     diseño <strong className="text-blue-950">web</strong>
//                 </h2>
//                 <p>
//                     Lorem ipsum dolor sit amet consectetur adipisicing elit.
//                     Vel, autem labore pariatur ad dolores quam non aspernatur
//                     soluta doloremque, corporis assumenda, sint suscipit et.
//                     Nisi adipisci a maxime! Sit, voluptatibus!
//                 </p>
//             </div>
//         </div>
//     );
